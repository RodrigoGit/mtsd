...
export class ContactService {
    ...
    private resourceUrl =  SERVER_API_URL + '/contact/api/contacts';
    private resourceUrlNif = SERVER_API_URL + '/contact/api/nif/get-nif';
    private resourceSearchUrl = SERVER_API_URL + '/contact/api/_search/contacts';
    ...
    nif(nif: string): Observable<Response> {
        alert('2');
        console.log('inicio--------');
        alert(`${this.resourceUrlNif}/${nif}`);
        return this.http.get(`${this.resourceUrlNif}/${nif}`);
    }
